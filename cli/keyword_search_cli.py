...
def main() -> None:
    ...
    tf_parser.add_argument("term", type=str, help="Term to get TF for")

    idf_parser = subparsers.add_parser("idf", help="Get inverse document frequency of a term")
    idf_parser.add_argument("term", type=str, help="Term to get IDF for")

    tfidf_parser = subparsers.add_parser("tfidf", help="Get TF-IDF score of a term in a document")
    ...
    bm25search_parser = subparsers.add_parser("bm25search", help="Search movies using BM25 with custom parameters")
    bm25search_parser.add_argument("query", type=str, help="Search query")
    bm25search_parser.add_argument("limit", type=int, nargs='?', default=DEFAULT_SEARCH_LIMIT, help="Number of results to return")
    ...
    match args.command:
        ...
        case "search":
            ...
            results = search_command(args.query, limit=DEFAULT_SEARCH_LIMIT)
        ...
        case "bm25search":
            print("Searching for:", args.query)
            results = bm25search_command(args.query, limit=args.limit, k1=args.k1, b=args.b)
            for i, res in enumerate(results, 1):
